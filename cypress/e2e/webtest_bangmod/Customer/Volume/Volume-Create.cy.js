...
describe('Volume / Create', () => {
    ...
    it('Validation (User specified the size exceeding the usage quota. The system display error Message "The number of sizes you specified exceeds your usage quota, please specify the number of sizes less than 995 or contact Support.")', () => {
        ...
        cy.get('[type="submit"]').click();
        cy.get('.text-danger').contains('The number of sizes you specified exceeds your usage quota, please specify the number of sizes less than 955 or contact Support.'); //แก้ไขจำนวน Size ก่อน test
        cy.wait(700);
    ...
    it('Usabilities (User go to Create Volume page. The system display :)', () => {
        ...
        cy.readFile(csvFilePath).then(csvData => {
            ...
            data.forEach((row) => {
                ...
                const Size = row.sizeVolume
                const Name = row.nameVolume
    ...
    it('Usabilities (User click Top Up Button. The system will direct to Top Up page”)', () => {
